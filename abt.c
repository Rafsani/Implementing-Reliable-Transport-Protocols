...
int main()
{
   ...
   printf("\n [%d] Number of packets received at Transport layer of B",pktTrans_B);
   printf("\n [%d] Number of packets received at Application layer of B",pktAppl_B);
   printf("\n Total time:%f",time);
